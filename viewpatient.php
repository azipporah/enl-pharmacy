...
if(isset($_POST['update-record'])){
  ...
  $patient_address=mysqli_real_escape_string($conn, $patient_address);
    $patient_disease=$_POST['patient_disease'];
  $patient_disease=mysqli_real_escape_string($conn, $patient_disease);
  ...
  $sql_insert="UPDATE patient SET patient_id='$patient_id', patient_name='$patient_name', patient_dateOfBirth='$patient_dateOfBirth', patient_gender='$patient_gender', patient_contact='$patient_contact', patient_email='$patient_email', patient_address='$patient_address', patient_disease='$patient_disease', patient_description='$patient_description',patient_dateOfEntry='$patient_dateOfEntry',WHERE patient_id='$patient_id'";
...
<form action="#" method="post">
                            ...
                            <div class="col-xs-12">
                                <button type="submit" class="btn btn-primary" name="update-records">Save Changes</button>
...
$sql_query=mysqli_query($conn, $sql_fetch);
 ...
 ?>
   <tbody>
    <tr>
     <th><?php echo $rows['patient_id'];?></th>
