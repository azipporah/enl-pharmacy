...
if(isset($_POST['update-record'])){
  ...
  $sql_insert="UPDATE stock SET sId='$stock_id', ename='$employee_name', p_name='$product_name',p_category='$product_category',p_unit='$product_unit',stock_expiry='$stock_expiryDate', quantity='$quantity', stock_desc='$stock_description' WHERE sId='$stock_id'";
...
?>
  ...
  $sql_delete="DELETE FROM stock WHERE sId='$stock_id'";
...
$sql_query=mysqli_query($conn, $sql_fetch);
 ...
 ?>
   <tbody>
    ...
    <td><span class="badge badge-primary"></span><?php echo $rows['product_unit'];?> </td>
    <td><?php echo $rows['stock_expiry'];?></td>
    <td></td>><?php echo $rows['quantity'];?></td>
