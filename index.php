...
<!-- Mirrored from medico.dexignzone.com/admin/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 May 2021 13:24:03 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>ENL Index </title>
    <!-- Favicon icon -->
...
function validateForm() {
  let x = document.forms["myForm"]["employee_email"].value;
  if (x == "") {
    alert("employee email must be filled out");
    return false;
  }
}
                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="#" id="form1" name="myForm" onsubmit="return validateForm()"  method="post">
                                        ...
                                        <!-- <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                            ...
                                            <div class="form-group">
                                                <a href="http://medico.dexignzone.com/xhtml/error-404.html">Forgot Password?</a>
                                            </div>
                                        </div> -->
