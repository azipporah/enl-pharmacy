...
if(isset($_POST['update-record'])){
  ...
  $sql_insert="UPDATE product SET p_id='$product_id', p_name='$product_name', category='$product_category' WHERE p_id='$product_id'";
...
?>
  ...
  $sql_delete="DELETE FROM productCategory WHERE product_id='$product_id'";
