...
// echo "updating successful";
  ...
  $sql_fetch="SELECT * FROM treatment WHERE p_name='$p_name'";
...
if(isset($_POST['update-record'])){
  ...
  $sql_insert="UPDATE treatment SET p_name='$patient_name',start_date='$start_date', end_date='$end_date',status='$t_status' WHERE p_name='$patient_name'";
...
?>
  ...
  $sql_delete="DELETE FROM treatment WHERE p_name='$patient_name'";
  ...
  // retrieving data
$sql_fetch="SELECT * FROM treatment";
$sql_query=mysqli_query($conn, $sql_fetch);
 ...
 ?>
   <tbody>
    ...
    <td><span class="badge badge-primary"></span><?php echo $rows['status'];?> </td>
     <td><a href="?delete=<?php echo $rows['patient_name'];?>">Delete</a></td>
    <td><a href="?update=<?php echo $rows['patient_name'];?>">Update</a></td>
    </tr>
                                        </tbody>
