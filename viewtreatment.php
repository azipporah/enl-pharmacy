...
?>
  ...
  // retrieving data
$sql_fetch = "SELECT treatment.treatment_id, patient.patient_name, product.product_name, treatment.start_date, treatment.end_date, treatment.treatment_status FROM patient join treatment on patient.patient_id = treatment.patient_id join product on product.product_id = treatment.product_id";
$query=mysqli_query($connect, $sql_fetch);
 ...
 ?>
    ...
    <td><span class="badge badge-primary"></span><?php echo $rows['treatment_status'];?> </td>
     <td><a href="?delete=<?php echo $rows['treatment_id'];?>">Delete</a></td>
    <td><a href="?update=<?php echo $rows['treatment_id'];?>">Update</a></td>
    </tr>
