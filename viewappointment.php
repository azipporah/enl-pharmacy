...
if(isset($_POST['update-record'])){
  ...
  $sql_insert="UPDATE appointment SET dateOfAppointment='$dateOfAppointment',created_at='$patient_name', status='$starus' WHERE aId='$appointment_id'";
...
<form action="#" method="post">
  ...
  $sql_delete="DELETE FROM appointment WHERE aId='$appointment_id'";
  ...
  // retrieving data
$sql_fetch="SELECT * FROM appointment";
$sql_query=mysqli_query($conn, $sql_fetch);
