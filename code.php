...
if(isset($_POST['Submit1'])){
	...
	$patient_gender=mysqli_real_escape_string($conn, $patient_gender);
	$patient_address=$_POST['patient_address'];
	$patient_contact=$_POST['patient_contact'];
	$patient_contact=mysqli_real_escape_string($conn, $patient_contact);
	$patient_email=$_POST['patient_email'];
	$patient_email=mysqli_real_escape_string($conn, $patient_email);
	$patient_dateOfBirth=$_POST['patient_dateOfBirth'];
	$patient_dateOfBirth=mysqli_real_escape_string($conn, $patient_dateOfBirth);
	$patient_dateOfEntry=$_POST['patient_dateOfEntry'];
	$patient_dateOfEntry=mysqli_real_escape_string($conn, $patient_dateOfEntry);
	$patient_description=$_POST['patient_description'];
	$patient_description=mysqli_real_escape_string($conn, $patient_description);
	...
	$sql_insert="INSERT INTO patient(patient_id,patient_name,patient_gender,patient_address,patient_contact,patient_email,patient_dateOfBirth,patient_dateOfEntry,patient_description,created_at,status) VALUES ('$patient_id','$patient_name','$patient_gender','$patient_address','$patient_contact','$patient_email','$dateOfBirth','$patient_dateOfEntry','$patient_description','$created_at','$status')";
