...
// echo "updating successful";
  ...
  $sql_fetch="SELECT * FROM productUnit WHERE product_id='$product_id'";
...
if(isset($_POST['update-record'])){
  ...
  $sql_insert="UPDATE product SET p_name='$productUnit_name', unit='$product_unit', p_unit='$product_unit' WHERE punit_id='$productUnit_id'";
...
$sql_query=mysqli_query($conn, $sql_fetch);
 ...
 ?>
   <tbody>
    <tr>
     <th><?php echo $rows['productUnit_id'];?></th>
    
    <td><span class="badge badge-primary"></span><?php echo $rows['productUnit_name'];?> </td>
    <td><?php echo $rows['product_unit'];?></td>
     <td><a href="?delete=<?php echo $rows['productUnit_id'];?>">Delete</a></td>
    <td><a href="?update=<?php echo $rows['productUnit_id'];?>">Update</a></td>
    </tr>
                                        </tbody>
