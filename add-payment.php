					...
					<div class="card-body">
						<form action="#" method="post">
							<div class="col-xs-12 row">
								...
								<div class="form-group col-sm-6">
									<label class="form-label" for="add-date">Date of Payment</label>
									<input type="date" id="add-date" name="dop" class="form-control datepicker" data-format="mm/dd/yyyy" value="">
								</div>
