...
if(isset($_POST['update-record'])){
 ...
 $cprice=$_POST['cprice'];
  ...
  $sql_insert="UPDATE product SET p_name='$product_name', p_category='$product_category', p_unit='$product_unit', dob='$stock_id', cprice='$product_costPrice', sprice='$sprice', dd='$product_dosage',manu='$product_manufacturer' WHERE p_id='$product_id'";
...
$sql_query=mysqli_query($conn, $sql_fetch);
 ...
 ?>
   <tbody>
    ...
    <td><span class="badge badge-primary"><?php echo $rows['expiry_date'];?></span> </td>
    <td><?php echo $rows['product_costPrice'];?></td>
    <td><?php echo $rows['product_sellingPrice'];?></td>
     <td><?php echo $rows['product_dosage'];?></td>
